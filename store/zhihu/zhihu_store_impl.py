...
class ZhihuDbStoreImplement(AbstractStore):
    async def store_content(self, content_item: Dict):
        ...
        if not note_detail:
            ...
            if "created_time" in content_item:
                content_item["create_date_time"] = utils.get_time_str_from_unix_time(content_item["created_time"])
    ...
    async def store_comment(self, comment_item: Dict):
        ...
        if not comment_detail:
            ...
            if "created_time" in comment_item:
                comment_item["create_date_time"] = utils.get_time_str_from_unix_time(comment_item["created_time"])
